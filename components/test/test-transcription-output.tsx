...
// export default function TestTranscriptionOutput({
//   rawTranscription,
//   processedOutput,
//   outputFormat,
//   onSave, //! TEST - LOCAL STORAGE
//   isSaved, //! TEST - LOCAL STORAGE
// }: {
//   rawTranscription: string;
//   processedOutput: string;
//   outputFormat: string;
//   onSave: () => void; //! TEST - LOCAL STORAGE
//   isSaved: boolean; //! TEST - LOCAL STORAGE
// }) {
