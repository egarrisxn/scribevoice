...
export default function CTA() {
  return (
    <section className="from-foreground/5 dark:from-foreground/10 via-background to-background grid w-full place-content-center place-items-center gap-5 bg-gradient-to-t px-4 pt-12 pb-24 text-center sm:px-6 sm:pt-28 sm:pb-36">
